export const it = {
  ...
  "creator.body":
    "Ciao! Sono uno studente di Ingegneria Informatica. Ho creato Pick & Pay per eliminare i paywall dalle serate tra amici.",
  ...
  "friends.addPlaceholder": "nickname dell'amico",
  ...
  "friends.duplicate": "Richiesta già inviata o amicizia già attiva.",
  "friends.pendingIn": "Richieste ricevute",
  "friends.pendingOut": "Richieste inviate",
  "friends.list": "Amici",
  "friends.none": "Ancora nessun amico. Condividi il tuo nickname per farti aggiungere.",
  ...
  "friends.share": "Manda agli amici",
  "friends.shareDone": "Inviato a {n} amici.",
  "friends.shareEmpty": "Seleziona almeno un amico.",

export const it = {
  ...
  "lobby.dutchHint": "Il prezzo crolla ogni secondo: il primo che lo prende se lo aggiudica",
  "auction.dutchTake": "PRENDI ORA",
  "auction.dutchNow": "Prezzo adesso",
  "auction.dutchFloor": "Prezzo al minimo",
  "auction.dutchTooDear": "Ancora oltre il tuo budget",
  "auction.dutchTaking": "Aggiudicazione…",
  "auction.dutchHint": "Il prezzo scende: vince chi si decide per primo",
  "auction.dutchSending": "INVIO IN CORSO…",
  "auction.dutchSniped": "⚡ Preso da {player} per un soffio, a {amount}",
  "auction.dutchFlop": "Nessuno l'ha preso: è un flop",
  "room.reconnecting": "Connessione persa: riprovo da solo…",
  "room.backOnline": "Di nuovo in linea",
  ...
  "lobby.gavel": "Batti il Martello",
  "lobby.gavelDone": "Martello battuto",
  "lobby.gavelWaiting": "Manca ancora {n} al martello",
  "lobby.gavelAllIn": "ASTA APERTA!",
  "lobby.gavelForce": "Avvia lo stesso",
  "lobby.gavelHint": "Battete tutti il martello per aprire l'asta",
  "home.botMode": "Come si gioca",
  "home.botModeClassic": "🔨 Asta Classica",
  "home.botModeDutch": "⚡ Dutch Draft",
  "home.botModeDutchHint": "Il prezzo scende: nessun turno, vince chi prende per primo",
  "home.botModeClassicHint": "Rilanci a salire, uno per volta",
  "home.botSetupTitle": "Sfida il Pick-asso Bot",
  "home.botExtras": "Varianti",
  "home.botStart": "Avvia Sfida 🚀",
  "rules.dutch": "Asta al ribasso (Dutch Draft).",
  "rules.dutchBody": "Il lotto parte al 60% del budget e il prezzo scende fino a un credito nell'arco del lotto. Non ci sono turni e non si rilancia: il lotto è aperto a tutti insieme e se lo aggiudica il primo che preme, al prezzo esposto in quell'istante. Aspettare costa meno ma rischia di più. Se non lo prende nessuno vale la regola dei flop. Si combina con le altre varianti: col Blind si punta al buio, e con la Mystery Box scende anche il prezzo della scatola.",
  "creator.log11": "⚡ Asta al ribasso e nuove liste",
  "creator.log11a": "Nuova modalità Dutch Draft: il prezzo parte alto e scende, non ci sono turni e vince chi prende per primo.",
  "creator.log11b": "Contro il Pick-asso Bot si sceglie come giocare: asta classica a turni oppure al ribasso.",
  "creator.log11c": "Due liste nuove: 5 Dita 5 Liquidi e Nuclear Bunker.",
  "creator.log11d": "Si apre col martello del banditore: si parte quando hanno battuto tutti, e chi ospita può forzare se qualcuno è fermo.",
  "creator.log11e": "Suoni rifatti per martello e batti pugno, e la vibrazione si fa più fitta man mano che il prezzo scende.",
  "results.fistBump": "Batti pugno",
  "results.fistBumpGot": "{n} batti pugno ricevuti",
  "results.voteHook": "L'asta è finita, ma chi ha fatto le scelte migliori? Fai votare la giuria!",
  ...
  "vote.errSelf":
    "Hai giocato questa partita: il voto è per chi guarda da fuori.",
  "vote.errAlready": "Hai già votato: il voto si dà una volta sola.",
  "vote.errUnknown": "Voto non registrato. Riprova.",
  "vote.linkCopied": "Link copiato! Mandalo a chi vuoi far votare 📋",
  "vote.playerTitle": "🎮 Sei un giocatore in questa partita!",
  "vote.playerBody":
    "Il tuo voto l'hai già dato alla fine dell'asta. Questo link è per gli amici: mandaglielo e falli votare.",
  "vote.playerCopy": "Copia il link da inviare",
  "vote.liveTitle": "Come sta andando",
  "vote.liveBody": "Hai votato. I risultati si aggiornano man mano che arrivano gli altri.",
  ...
  "history.empty": "Nessuna partita ancora. Giocane una e comparirà qui.",
  "history.vs": "TU vs {player}",
  "history.vsBot": "TU vs Pick-asso 🤖",
  "history.duel": "TU vs un avversario",
  "history.table": "TU e altri {n} al tavolo",
  "history.guestVoter": "Ospite",
  "history.noVotes": "Nessun voto ricevuto.",
  "history.noDetail": "Per questa partita non è stato generato un link di voto.",

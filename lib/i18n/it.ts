export const it = {
  ...
  "picker.xpRow": "Livelli e ricompense",
  "picker.xpGuest": "Livello 0 fisso: Turista delle Aste",
  "picker.xpMember": "Sali fino a Tycoon Supremo: cornici e titoli",
  "picker.nameRow": "Il tuo nome sulla card",
  "picker.nameGuest": "Sulla card compare “Lvl 0 · Ospite”",
  "picker.nameMember": "Il tuo @nickname, riservato solo a te",
  ...
  "picker.matesGuest": "ogni volta copi il codice, apri WhatsApp, incolli e aspetti che lo leggano.",
  "picker.matesMember": "i tuoi amici restano in rubrica: li inviti dalla lista e la sfida arriva sul loro telefono, con la battuta.",
  "picker.statsGuest": "finita la serata la tua vittoria sparisce per sempre.",
  "picker.statsMember": "resta la tua carriera: aste vinte, percentuale di successo e l'elenco delle ultime partite, per poter dire «la settimana scorsa ti ho battuto».",
  "picker.trophies": "Trofei e livelli",
  "picker.trophiesGuest": "nessun riconoscimento: giochi e finisce lì.",
  "picker.trophiesMember": "sblocchi i trofei (Primo colpo, Prima vittoria, Branco) e sali di livello: da Novizio a Picker fino a Lupo d'asta.",

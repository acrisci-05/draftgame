...
export const en: Dictionary = {
  ...
  "lobby.dutchHint": "The price drops every second: the first to take it wins the lot",
  "auction.dutchTake": "TAKE IT NOW",
  "auction.dutchNow": "Price now",
  "auction.dutchFloor": "Price at the floor",
  "auction.dutchTooDear": "Still above your budget",
  "auction.dutchTaking": "Awarding…",
  "auction.dutchHint": "The price is falling: whoever moves first wins",
  "auction.dutchSending": "SENDING…",
  "auction.dutchSniped": "⚡ {player} beat you to it by a whisker, at {amount}",
  "auction.dutchFlop": "Nobody took it: it's a flop",
  "room.reconnecting": "Connection lost: retrying on its own…",
  "room.backOnline": "Back online",
  ...
  "lobby.gavel": "Strike the Gavel",
  "lobby.gavelDone": "Gavel struck",
  "lobby.gavelWaiting": "Still waiting on {n}",
  "lobby.gavelAllIn": "AUCTION OPEN!",
  "lobby.gavelForce": "Start anyway",
  "lobby.gavelHint": "Everyone strike the gavel to open the auction",
  "home.botMode": "How to play",
  "home.botModeClassic": "🔨 Classic auction",
  "home.botModeDutch": "⚡ Dutch Draft",
  "home.botModeDutchHint": "The price falls: no turns, first to take it wins",
  "home.botModeClassicHint": "Rising bids, one player at a time",
  "home.botSetupTitle": "Challenge the Pick-asso Bot",
  "home.botExtras": "Variants",
  "home.botStart": "Start the challenge 🚀",
  "rules.dutch": "Dutch Draft (falling-price auction).",
  "rules.dutchBody": "The lot opens at 60% of the budget and the price falls to one credit over the lot. No turns, no raises: the lot is open to everyone at once and goes to whoever taps first, at the price showing right then. Waiting costs less but risks more. If nobody takes it, the flop rule applies. It combines with the other variants: with Blind you bet blind, and with Mystery Box the box price falls too.",
  "creator.log11": "⚡ Falling-price auction and new lists",
  "creator.log11a": "New Dutch Draft mode: the price starts high and falls, there are no turns, and whoever taps first wins.",
  "creator.log11b": "Against the Pick-asso Bot you now choose how to play: classic turn-based auction or falling price.",
  "creator.log11c": "Two new lists: 5 Fingers 5 Liquids and Nuclear Bunker.",
  "creator.log11d": "The auction opens with the gavel: it starts once everyone has struck, and the host can force it if someone is idle.",
  "creator.log11e": "Rebuilt gavel and fist-bump sounds, and the vibration gets tighter as the price falls.",
  "results.fistBump": "Fist bump",
  "results.fistBumpGot": "{n} fist bumps received",
  "results.voteHook": "The auction is over, but who made the best calls? Let the jury vote!",

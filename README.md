...
- **36 liste ufficiali** con nomi corti ed emoji di copertina, definite in `data/categories.json`,
...
data/categories.json    liste ufficiali: 36 categorie (30 elementi; 20 le regioni, 45 le auto)
